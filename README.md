# HR Chatbot System - Local AI Assistant

## 🚀 系统状态: 已升级并修复 ✅

这是一个企业级HR聊天机器人应用，能够使用本地AI模型回答HR相关问题。系统已成功升级到最新版本的LangChain，并使用本地Ollama模型替代了OpenAI API。
...
It was made using LangChain's agents and tools modules, using **FAISS as vector database** and powered by **local Ollama models**. The front-end is Streamlit using the streamlit_chat component.

**🔄 重要更新**: 系统已从OpenAI API迁移到本地Ollama模型，解决了地区限制问题。
